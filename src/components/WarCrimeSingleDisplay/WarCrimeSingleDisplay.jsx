...
const EvidenceSlide = ({typeOfEvidence, media,  id, description, source, numberOfEvidences, videoThumbPlaceholder})=>{

    const [isImageLoading, setisImageLoading] = useState(true)
    const [isVideoLoading, setisVideoLoading] = useState(true)

    return(
 <div className={`min-h-screen relative pt-10 w-full h-full bg-gray-800`}>
        ...
        <>
           {
            ...
            <div className={`absolute text-white top-32 left-0 min-h-screen w-full z-20`}>
                  <iframe onLoad={()=>{setisVideoLoading(true)}} id="reddit-embed" src={media} sandbox="allow-scripts allow-same-origin allow-popups"
                   style={{border:"none"}}
...

                    {
                         credibleAgenciesThatChecked ?
                                      ...
                                      <div onClick={()=>{}} className={`transition-opacity duration-150 ease-in-out cursor-pointer opacity-90 hover:opacity-100`}>
                                          <Chip
                                                      className={`pointer-events-none`}
                                                      icon={checkWhichChipIconToBeDisplayed("confirmed")}
                        ...
                        :
                                    <Chip
                                    className={`pointer-events-none`}
                                    icon={checkWhichChipIconToBeDisplayed("warning")}
                            ...
                            return (
                                <div>
                                    <EvidenceSlide
                                     ...
                                     videoThumbPlaceholder={element.videoThumbPlaceholder}
                                     />
                                </div>
                                )
